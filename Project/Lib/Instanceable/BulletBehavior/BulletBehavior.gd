...
tool #Used for notifying configuration warnings.
extends Node

class_name BulletBehavior

""" 
	The Bullet behavior simply moves object forwards at
	...
	**Usage**
	...
	This will work on a target node having 'position' property.
	Specify which root node you want to have this behavior
	by setting `root_node` property.
"""
